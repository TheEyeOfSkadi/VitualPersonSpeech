...
namespace VitualPersonSpeech.Utils
{
    ...
    class XunFeiUtils
    {
        //string str = Marshal.PtrToStringAnsi(); IntPtr转化
        ...
        public static extern int MSPLogin(string usr, string pwd, string paramsStr);
        ...
        #region 讯飞语音唤醒dll中的方法
        //https://www.xfyun.cn/doc/asr/awaken/Windows-SDK.html#_2%E3%80%81sdk%E9%9B%86%E6%88%90%E6%8C%87%E5%8D%97
        //https://www.xfyun.cn/doc/mscapi/Windows&Linux/wlapi.html#qivw-h-%E8%AF%AD%E9%9F%B3%E5%94%A4%E9%86%92
        ...
        /// <returns></returns>
        [DllImport("msc_x64.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern IntPtr QIVWSessionBegin(string grammarList, string paramsStr, ref int errorCode);
    ...
    public enum ErrorCode
    {
        ...
        MSP_IVW_MSG_WAKEUP = 1,//唤醒消息
        MSP_IVW_MSG_ERROR = 1,//出错通知消息
        MSP_IVW_MSG_ISR_RESULT = 3,//唤醒+识别结果消息
        MSP_IVW_MSG_ISR_EPS = 4,//唤醒+识别结果中vad 端点检测消息
