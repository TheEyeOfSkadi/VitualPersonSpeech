...
namespace VitualPersonSpeech.Model
{
    ...
    /// 百度文心一言结果
    /// </summary>
    class WenXinResult_ERNIE_Lite_8K_0922
    {
        ...
        public WenXinResult_ERNIE_Lite_8K_0922()
        {
        }

        public WenXinResult_ERNIE_Lite_8K_0922(string id, string objectStr, long created, string result, bool is_truncated, bool need_clear_history)
        {
            this.id = id;
